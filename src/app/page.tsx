    ...
    <div>
      ...
      <section className="mb-12">
        ...
        <ul className="custom-list space-y-2">
          <li>I live in Los Angeles with my wife and our two cats.</li>
      ...
      <section className="mb-12">
        ...
        <ul className="custom-list space-y-2">
          ...
          <li>I co-own <a href="https://fioredesigns.com/" className="text-blue-600 hover:underline" target="_blank">Fiore Designs</a>, a flower design studio in Culver City with my wife.</li>
        </ul>
      </section>
