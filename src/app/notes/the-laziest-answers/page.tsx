...
export default function TheLaziestAnswersPage() {
  return (
    <div className="max-w-prose-wide mx-auto py-16 md:py-20 px-6 sm:px-8">
      ...
      <article>
        ...
        <div className="prose-article">
          ...
          <p>
            Ask someone how consciousness works and they might say God designed it. But this explains nothing about how consciousness actually works. It&apos;s just a way of saying &ldquo;I don&apos;t know&rdquo; while feeling like you do. The question remains exactly where it was; you&apos;ve just given it a label.
          </p>
          ...
          <p>
            Which means you could, if you wanted, simply not have them. You could hold the questions open. You could look at the mystery of existence and say &ldquo;I don&apos;t know&rdquo; and leave it at that. You could tolerate the hole.
          </p>
